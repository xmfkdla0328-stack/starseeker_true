    ...
    <div className="flex-1 flex flex-col relative z-10 animate-fade-in p-6">
      ...
      <div className="flex-1 flex flex-col gap-4 justify-center">
        ...
        <button 
          ...
          className="group relative w-full h-40 bg-gradient-to-r from-indigo-900/40 to-cyan-900/40 border border-white/10 hover:border-cyan-400/50 rounded-2xl p-6 flex items-center justify-between transition-all hover:scale-[1.02] active:scale-95 overflow-hidden"
        >
          {/* 배경 효과 */}
          ...
          <div className="relative z-10 flex flex-col items-start gap-2">
            ...
            <p className="text-xs text-slate-400 font-light text-left pl-1">
              미지의 좌표를 탐사하고<br/>
              성운의 기억을 추적합니다.
            </p>
        ...
        <button 
          ...
          className="group relative w-full h-40 bg-gradient-to-r from-slate-900/40 to-amber-900/20 border border-white/10 hover:border-amber-400/50 rounded-2xl p-6 flex items-center justify-between transition-all hover:scale-[1.02] active:scale-95 overflow-hidden"
        >
