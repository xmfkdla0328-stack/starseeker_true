...
import { ArrowLeft, HardDrive, Hexagon, Swords, AlertTriangle } from 'lucide-react';
    ...
    <div className="flex-1 flex flex-col relative z-10 animate-fade-in p-6 h-full bg-[#0f172a] text-slate-100">
      ...
      <div className="flex-1 flex flex-col gap-4">
        ...
        <button 
            ...
            className="group relative w-full bg-slate-900/80 border border-cyan-500/30 hover:border-cyan-400 rounded-xl p-5 text-left transition-all hover:bg-slate-800 active:scale-98"
        >
        ...
        <button 
            ...
            className="group relative w-full bg-slate-900/80 border border-violet-500/30 hover:border-violet-400 rounded-xl p-5 text-left transition-all hover:bg-slate-800 active:scale-98"
        >
            <div className="flex justify-between items-start mb-2">
                <div className="flex items-center gap-3">
